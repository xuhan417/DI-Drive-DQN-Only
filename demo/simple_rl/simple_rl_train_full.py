...
def wrapped_discrete_env(env_cfg, wrapper_cfg, host, port, tm_port=None):
    ...
    # return BenchmarkEnvWrapper(env, wrapper_cfg) # ---> For simple-rl-v1
    return env
...
def main(args, seed=0):
    ...
    # init collector and evaluator envs
    ...
    while True:
        # evaluate policy
        # print('---- eval result !!! ----')
        # print( 'If should eval : ' + str(evaluator.should_eval(learner.train_iter)))
