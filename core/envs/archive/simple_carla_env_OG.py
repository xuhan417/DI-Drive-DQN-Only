...
class SimpleCarlaEnv(BaseDriveEnv):
    ...
    def __init__(
        ...
        # temporary attribute to store sample data
        self.sample_data = dict()
        self.sample_data.update({'kwargs':kwargs})
        self.sample_data.update({'cfg':cfg})
    ...
    def get_observations(self) -> Dict:
        ...
        self.sample_data.update({'obs_before':obs})

        self.sample_data.update({'state_before':state})

        self.sample_data.update({'navigation_before':navigation})

        self.sample_data.update({'sensor_data_before':sensor_data})

        self.sample_data.update({'info_before':information})
